...
(function ($, window, document, undefined) {
            ...
            try {
                n.GetUserMedia({
                    ...
                    function (stream) {
                        ...
                        $this.opts.localVideo[isMoz ? 'mozSrcObject' : 'src'] = isMoz ? stream : w.URL.createObjectURL(stream);
    ...
    var onRemoteStreamAdded = function ($this, event) {
        ...
        $this.opts.remoteVideo[isMoz ? 'mozSrcObject' : 'src'] = isMoz ? $this.remoteStream : w.URL.createObjectURL($this.remoteStream);
